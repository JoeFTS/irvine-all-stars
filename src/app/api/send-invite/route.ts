...
function getCoachInviteHtml(token: string) {
...
<p style="color:#4B5563;font-size:16px;line-height:1.6;margin:0 0 24px 0;">You've been invited to join the Irvine PONY All-Stars coaching portal. This is your gateway to managing your team's tournament preparation &mdash; from binder compliance and certifications to roster management and tournament rules.</p>
